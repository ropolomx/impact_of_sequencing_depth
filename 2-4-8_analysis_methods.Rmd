...
The following FASTQ datasets were analyzed with a modified version of the AMRPlusPlus workflow in the Galaxy instance of the Nationtablet_linux_x64_1_16_09_06.shal Microbiology Laboratory (Public Health Agency of Canada). 
...
The modifications to the workflow include the integration of taxonomical classification (Kraken) in the same workflow, and the ommission of filtering reads vs. host genome.
